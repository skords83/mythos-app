...
interface EditItemModalProps {
  ...
  onClose: () => void
  item: Item | null
  onUpdate: (id: string, name: string, description: string, origin: string, significance: string, visibility: 'PRIVATE' | 'FAMILY') => void
}

export function EditItemModal({ isOpen, onClose, item, onUpdate }: EditItemModalProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    onUpdate(item.id, name, description, origin, significance, visibility)
    onClose()
  }
